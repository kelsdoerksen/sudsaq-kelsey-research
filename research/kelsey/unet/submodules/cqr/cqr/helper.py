...
def run_icp(nc, X_train, y_train, X_test, ytest, idx_train, idx_cal, significance, condition=None):
    ...
    predictions = icp.predict(X_test, ytest, significance=significance)
